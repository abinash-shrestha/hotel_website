      ...
      <form id="login-form">
        ...
        <div class="modal-body">
          ...
          <div class="d-flex align-items-center justify-content-between mb-2">
            ...
            <button type="button" class="btn text-secondary text-decoration-none shadow-none p-0" data-bs-toggle="modal" data-bs-target="#forgotModal" data-bs-dismiss="modal" hidden>
              Forgot Password?
            </button>
          </div>
        </div>
          ...
          <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-md-6 mb-3">
                ...
                <input name="dob" type="date" class="form-control shadow-none" required max="<?php echo date('Y-m-d'); ?>">
              </div>
              <div class="col-md-6 mb-3">
                <label class="form-label">Password</label>
